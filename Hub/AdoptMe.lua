...
spawn(function()
    ...
    if txt then
        ...
        if request then
            ...
            elseif respuesta.Body ~= "False" then
                Player:Kick("I have not been able to recover the information of the Hub account, for more information enter the Discord: discord.gg/rR42njFhEz")
            end
        end
    end
end)
